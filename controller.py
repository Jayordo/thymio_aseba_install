...
def Braitenberg():
	...
	network.GetVariable("thymio-II", "button.center", reply_handler=get_center_button,error_handler=get_variables_error)
	...
	rightWheel=[-0.01,-0.005,-0.0001,0.006,0.015]
	#rightWheel=[0.012,0.007,-0.0002,-0.0055,-0.011]
	leftWheel=[0.012,0.007,-0.0002,-0.0055,-0.011]
...
if __name__ == '__main__':
	...
	handle = glib.timeout_add(1000, Braitenberg) #every 0.1 sec
	loop.run()
